...
# Takes in Northern Hemisphere surface temp and returns sea levels
...
# Just uses linear regression generated by Wolfram
def sealevel(temperatures):
  return list(map(lambda t : -2.51 + 1.63*t - 12.68, temperatures))

# Converts temperature deltas into absolute
